    ...
    <div class="Modal_modalContent__0zuTn style_wrapper__SO1vd border-none" style="width: 400px; overflow-y: auto;">
      ...
      <div id="MODAL_BODY" class="ModalBody Body_body__KI0OY SignUpOrLogin_modal__VDGVH">
        ...
        <div class="InputPanel_wrapper__RXp1k">
              <input class="InputPanel_password__my_BO" type="password" autocomplete="password" />
            <div class="style_wrapper__6RiUK InputPanel_email__aEAmZ">
              <label for="email" class="style_label__BKYHB">이메일</label>
                <div class="style_body__A6XnO">
                  <input type="email" placeholder="이메일을 입력해 주세요." id="email" value="" />
                </div>
                <div class="style_guidance__FT8Qs input-group-guidance">
                </div>
            </div>
            <div class="InputPanel_buttons__w391m">
              ...
              <div class="InputPanel_socialWrapper__Dhaxo isKR">
                <div class="InputPanel_socialButton__Hggw2 isKR">
                  <button type="button" class="style_wrapper__IgK7U social-login-button kakao-login">
                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="21" viewBox="0 0 22 21">
                      <path fill="#000" fill-rule="nonzero" d="M11 0C5.242 0 0 3.823 0 8.539c0 2.932 1.904 5.519 4.804 7.056l-1.22 4.479c-.107.397.343.712.69.483l5.348-3.548c.452.044.91.069 1.377.069 6.076 0 11-3.823 11-8.54 0-4.715-4.924-8.538-11-8.538"></path>
                    </svg>
                    <div class="InputPanel_socialTitle__77isU isKR">Kakao</div>
                  </button>
                </div>
                <div class="InputPanel_socialButton__Hggw2 isKR">
                  <button type="button" class="style_wrapper__IgK7U social-login-button facebook-login">
                    <svg xmlns="http://www.w3.org/2000/svg" width="12" height="23" viewBox="0 0 12 23">
                      <path fill="#fff" fill-rule="nonzero" d="M11.214 12.603l.622-4.055h-3.89V5.917c0-1.11.543-2.191 2.285-2.191H12V.274S10.395 0 8.86 0C5.656 0 3.562 1.942 3.562 5.458v3.09H0v4.055h3.562v9.802c.714.112 1.446.17 2.191.17.746 0 1.478-.058 2.192-.17v-9.802h3.269"></path>
                    </svg>
                    <div class="InputPanel_socialTitle__77isU isKR">Facebook</div>
                  </button>
                </div>
                <div class="InputPanel_socialButton__Hggw2 isKR">
                  <button type="button" class="style_wrapper__IgK7U social-login-button google-login">
